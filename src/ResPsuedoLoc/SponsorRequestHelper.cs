...
namespace ResPsuedoLoc
{
    public class SponsorRequestHelper
    {
        ...
        private static async Task ShowPromptForSponsorshipAsync()
        {
			...
			OutputPane.Instance.WriteLine("leave a positive review at https://marketplace.visualstudio.com/items?itemName=MattLaceyLtd.ResourcePseudoLocalizer&ssr=false#review-details");
			OutputPane.Instance.WriteLine("");
			OutputPane.Instance.WriteLine("********************************************************************************************************");
		}
    }
